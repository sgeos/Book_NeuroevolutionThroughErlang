...
%   {
%     atom()::MO_Name,
%     { float()::ElementA_LayerCoordinate, atom()::ElementA_Type },
%     { float()::ElementB_LayerCoordinate, atom()::ElementB_Type },
%     { float()::ElementC_LayerCoordinate, atom()::ElementC_Type }
%   },
%   {
%     atom()::MO_Name,
%     { float()::ElementA_LayerCoordinate, atom()::ElementA_Type },
...
% neural_pfs = [ none, hebbian, neuro_modulated ],
% neural_aggr_fs = [ dot_product, mult_product, diff ],
% tuning_selection_fs = [ all, all_random, recent, recent_random, lastgen, lastgen_random ],
% tuning_duration_f = [ { const,any()::Parameter }, { size_proportional, any()::Parameter } ... ],
% annealing_parameters = [ 0 ], % [ 0, 1, 2, 0.5 ... ]
% perturbation_ranges = [ 1 ], % [ 0.5, 1, 2, 3 ... ]
% agent_encoding_types = [ neural, substrate ],
% mutation_operators = [ { atom()::FunctionName, float() } ... ],
% tot_topological_mutations_fs = [ { ncount_exponential, 0.5 }, { ncount_linear, 1 } ],
